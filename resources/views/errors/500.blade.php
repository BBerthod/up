    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .indicator {
            ...
            border-radius: 20px; padding: 6px 14px; font-size: 12px; color: #f87171; margin-bottom: 24px;
        }
        .indicator::before {
...
<body>
    <div class="container">
        ...
        <div class="card">
            <div class="indicator">Error Detected</div>
            ...
            <a href="/dashboard" class="btn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M8 2L2 7H5V14H11V7H14L8 2Z"/></svg>
                Back to Dashboard
            </a>
        </div>
    </div>
