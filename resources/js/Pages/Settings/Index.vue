    ...
    <div class="space-y-6">
        ...
        <div class="glass p-6">
            ...
            <form @submit.prevent="createToken" class="flex items-end gap-4 mb-6">
                ...
                <button type="submit" class="btn-primary" :disabled="tokenForm.processing">Create Token</button>
            </form>
                    ...
                    <tbody>
                        <tr v-for="token in tokens" :key="token.id" class="border-b border-white/5 last:border-0">
                            ...
                            <td class="py-3 text-right">
                                <button @click="deleteToken(token.id)" class="text-red-400 hover:text-red-300 text-sm transition-colors">Revoke</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
