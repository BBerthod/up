    ...
    <div v-else class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <button @click="showPurgeDialog = true" aria-label="Purge monitor data" class="px-4 py-2 rounded-lg text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 transition-colors">Purge data</button>
