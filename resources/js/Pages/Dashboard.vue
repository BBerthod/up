...
<template>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="glass p-5" title="Total number of configured monitors">
            ...
            <div class="glass p-5" title="Combined uptime across all monitors (24 hours)">
                <div class="flex items-center gap-3 mb-3">
            ...
            <div class="glass p-5" title="Average response time across all monitors">
                <div class="flex items-center gap-3 mb-3">
            ...
            <div class="glass p-5" title="Unresolved incidents across all monitors">
                <div class="flex items-center gap-3 mb-3">
